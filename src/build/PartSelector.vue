<template>
  <div class="part" :class="position">
    ...
    <span
      @click="pinValue='40px'"
      v-pin="{top: pinValue, right: pinValue, bottom: 'auto'}"
...
export default {
  ...
  props: {
    ...
    position: {
      ...
      required: true,
      validator(value) {
        return ['top', 'center', 'left', 'right', 'bottom'].includes(value);
      }
    }
  },
  data() {
    return { selectedPartIndex: 0, pinValue: '23px' };
  },
  computed: {
    selectedPart() {
